...
|-----------|---------|--------|
| `n3-raft-finetuning/` | 国税庁 FAQ × RAFT で Nemotron 9B-v2 の RAG 精度を上げてみた | Published |
| `n5-constitutional-ai-simpo/` | クラスメソッドのカルチャー（CLP）を Nemotron 9B-v2 に教え込んでみた | Published |
